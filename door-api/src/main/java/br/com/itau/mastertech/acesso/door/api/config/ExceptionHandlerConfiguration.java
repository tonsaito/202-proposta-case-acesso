package br.com.itau.mastertech.acesso.door.api.config;

import br.com.itau.mastertech.acesso.door.api.exception.DoorNotFoundException;
import br.com.itau.mastertech.acesso.door.api.model.ExceptionModel;
...
public class ExceptionHandlerConfiguration extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = { DoorNotFoundException.class})
